            ...
            <div id="kt_aside" class="aside py-9 " data-kt-drawer="true" data-kt-drawer-name="aside"
                ...
                <div class="aside-logo flex-column-auto px-9 mb-9" id="kt_aside_logo">
                    ...
                    <a href="{{ route('admin.dashboard') }}">
                        <img alt="Logo" src="{{ asset('images/logos/logo-4.png') }}"
                        ...
                        <div class="menu menu-column menu-rounded menu-sub-indention menu-active-bg fw-semibold my-auto"
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                ...
                                <span class="menu-link">
                                    ...
                                    <span class="menu-title">Transaksi</span><span class="menu-arrow"></span>
                                </span>
                                {{-- end:Menu link --}}
                                {{-- begin:Menu sub --}}
                                <div class="menu-sub menu-sub-accordion">
                                    ...
                                    <div class="menu-item menu-accordion">
                                        {{-- begin:Menu link --}}
                                        <a class="menu-link" href="{{ route('admin.income-transactions.index') }}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                    ...
                                    <div class="menu-item menu-accordion">
                                        {{-- begin:Menu link --}}
                                        <a class="menu-link" href="{{ route('admin.outcome-transactions.index') }}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                    ...
                    <div class="d-flex flex-stack">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="symbol symbol-circle symbol-40px">
                                @if (Auth::user()->image != null)
                                    <img src="{{ asset('storage/user-images/' . Auth::user()->id . '/' . Auth::user()->image) }}"
                                        alt="photo" />
                                @else
                        ...
                        <div class="ms-1">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                                data-kt-menu="true">
                                {{-- begin::Menu item --}}
                                <div class="menu-item menu-accordion px-3">
                                    <div class="menu-content d-flex align-items-center px-3">
                                        {{-- begin::Avatar --}}
                                        <div class="symbol symbol-50px me-5">
                                            @if (Auth::user()->image != null)
                                                <img alt="Logo"
                                                    src="{{ asset('storage/user-images/' . Auth::user()->id . '/' . Auth::user()->image) }}" />
                                            @else
                                                <img alt="Logo"
                                ...
                                {{-- end::Menu separator --}}
                                {{-- begin::Menu item --}}
                                <div class="menu-item menu-accordion px-5">
                                ...
                                {{-- begin::Menu item --}}
                                <div class="menu-item menu-accordion px-5">
                                    <a href="{{ route('admin.password.edit') }}" class="menu-link px-5">
                                        Ubah Kata Sandi
                                    </a>
                                </div>
                                {{-- end::Menu item --}}
                        ...
                        <div class="d-flex align-items-center flex-shrink-0">
                            ...
                            <div class="d-flex align-items-center ms-3 ms-lg-4">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-muted menu-active-bg menu-state-color fw-semibold py-4 fs-base w-150px"
                                    ...
                                    {{-- begin::Menu item --}}
                                    <div class="menu-item menu-accordion px-3 my-0">
