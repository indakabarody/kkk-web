            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div class="card-header border-0 pt-5">
                    ...
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        {{-- begin::Add admin --}}
                        <button type="button" onclick="location.href='{{ route('admin.outcome-transactions.create') }}';"
                ...
                <div class="card-body py-3">
                    ...
                    <div class="table-responsive">
                        {{-- begin::Table --}}
                        <table id="kt_transactions_table" class="table align-middle table-row-dashed fs-6 gy-5">
                            {{-- begin::Table head --}}
                            <thead>
                            ...
                            <tbody>
                                @foreach ($transactions as $transaction)
                                    <tr>
                                        ...
                                        <td>{{ Akaunting\Money\Money::IDR($transaction->amount_idr ?? 0) }}</td>
                                        ...
                                        <td>
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="{{ route('admin.outcome-transactions.edit', $transaction->id) }}"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="#" class="menu-link px-3" data-bs-toggle="modal"
                                                        ...
                                                        onclick="setDelete('{{ route('admin.outcome-transactions.destroy', $transaction->id) }}')">Hapus</a>
                                                </div>
                                                {{-- end::Menu item --}}
                                            </div>
                                            {{-- end::Menu --}}
